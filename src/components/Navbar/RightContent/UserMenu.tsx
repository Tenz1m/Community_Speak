...
const UserMenuList: React.FC<UserMenuListProps> = ({
  ...
  return (
    <MenuList borderRadius={15} mt={2} shadow="lg">
      <Flex justifyContent="center">
        <Stack spacing={1} width="95%">
          {user ? (
            <>
              <CustomMenuButton
                icon={<CgProfile color="#3ca80a"/>}
                text="Profile"
              ...
              />
              <CustomMenuButton
                icon={<FaBookJournalWhills color="#dfe619" />}
                text="New Books"
                onClick={() => {
                  router.push("/books");
                }}
              ...
              />
              <CustomMenuButton
                icon={<TbUsersGroup color="#130c94" />}
                text="Communities"
                onClick={onClick} 
              />

              <CustomMenuButton
                icon={<MdOutlineLogin color="red" />}
                text="Log Out"
                onClick={logout}
              />
            </>
