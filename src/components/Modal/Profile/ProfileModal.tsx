    ...
    <>
      <Modal isOpen={open} onClose={handleClose}>
        <ModalOverlay
          ...
          backdropBlur="5px"
        />
        <ModalContent borderRadius={10} css={{ width: '80%', maxHeight: '80%' }}>
          <ModalHeader
            display="flex"
          ...
          <Box>
            <ModalCloseButton />
            <ModalBody display="flex" flexDirection="column" padding="20px 0px">
              <Stack p={5} spacing={5}>
                {/* image */}
                ...
                {!isEditing && (
                  <Flex direction="column">
                    <Flex direction="row">
                      ...
                      <Text fontSize="16pt" fontFamily="Body Font Name">{user?.email}</Text>
                    </Flex>
                    <Flex direction="row">
                      <Text
                        fontSize="16pt"
                      ...
                      <Text fontSize="16pt" fontFamily="Body Font Name">{user?.displayName || ""}</Text>
                    </Flex>
                  </Flex>
                )}
                {isEditing && (
