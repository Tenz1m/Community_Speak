  ...
  return (
    <PageContentLayout maxWidth="1060px">
     <Box color="Red" p="14px 0px" borderBottom="1px solid" borderColor="white">
          <center>
          <Text fontWeight={900}>Bus Live Location</Text>
          </center>
      {/* <MyComponent/> */}
     ...
     <Box>
      ...
      <MyComponent/>
      <br/>
      <Image style={{ width: "500px", height: "300px" }} src="https://media.istockphoto.com/id/472292369/vector/school-bus.jpg?s=612x612&w=0&k=20&c=FvuZ3yPQiGFQ3DM6HXyJO8qzfA1nGkyptw3jdN6p5ds=" alt="bus" />
      </Box>
    </PageContentLayout>
  );
};
